...
export default function RegsitroExitoso() {
  return (
    <div className="container-registro-exitoso">
      <div className="registro-exitoso">
        <div className="container-estrellas">
          <svg
            className="estrella-uno"
            version="1.0"            
...
-4 5 -55 -139 -114 -320z"
        ...
        <p className="felicitaciones">¡Felicitaciones!</p>
        <p className="exitoso">Tu registro se realizo con exito.</p>
        <p className="contenido">
          Ya podes acceder a todo nuestro nuestro contenido
        </p>
